...
- All code and versioned work: `holos_tools/`, tests, agent defs (`.Codex/agents/`)
...
- This constitution: `AGENTS.md` (non-negotiable rules + Definition of Done/Ready)
...
3. **`.Codex/agents/*.md`** — current agent defs if you're calling an agent

You never work from stale assumptions because the repo is the single source of truth.

**Critical rule:** Do NOT modify AGENTS.md's non-negotiable rules or Definition of Done
